        ...
        <div class="nk-header-wrap">
            <div class="nk-header-logo ms-n1">
                ...
                <a href="{{ route('dashboard') }}" class="logo-link">
                    <div class="logo-wrap">
                        <img class="logo-img logo-light" src="{{ asset('assets/images/contentpilot-logo.svg') }}"
                            srcset="{{ asset('assets/images/contentpilot-logo.svg') }}" alt="ContentPilot">
                        <img class="logo-img logo-dark" src="{{ asset('assets/images/contentpilot-logo.svg') }}"
                            srcset="{{ asset('assets/images/contentpilot-logo.svg') }}" alt="ContentPilot">
                        <img class="logo-img logo-icon" src="{{ asset('assets/images/contentpilot-icon.svg') }}"
                            srcset="{{ asset('assets/images/contentpilot-icon.svg') }}" alt="ContentPilot">
                    </div>
                </a>
            </div>
                                    ...
                                    <a class="d-flex px-3 py-2 bg-primary bg-opacity-10 rounded-bottom-3"
                                        ...
                                        <div class="media-group">
                                            ...
                                            <div class="media-text">
                                                <h6 class="fs-6 mb-0">{{ Auth::user()?->name ?? 'User' }}</h6>
                                                <span class="text-light fs-7">{{ Auth::user()?->email ?? 'user@example.com' }}</span>
                                            </div>
