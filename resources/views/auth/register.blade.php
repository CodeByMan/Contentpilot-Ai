...
<head>
    ...
    <title>ContentPilot - Register</title>
        ...
        <div class="nk-main">
            <div class="nk-wrap has-shape flex-column">
                ...
                <div class="text-center pt-5">
                    <a href="{{ url('/') }}" class="logo-link auth-logo-link" aria-label="ContentPilot home">
                        <div class="logo-wrap auth-logo-wrap">
                            <img class="logo-img auth-logo-icon" src="{{ asset('assets/images/contentpilot-icon.svg') }}" srcset="{{ asset('assets/images/contentpilot-icon.svg') }}" alt="ContentPilot">
                        </div>
                    </a>
                </div>
