...
<div class="container">
    ...
    $headingTitle = $heading?->title ?? 'Generate polished content in three simple steps';
    $headingDescription = $heading?->description ?? 'Select a template, provide your topic details, and let the AI generate clean, editable English content in seconds.';
    $isEditable = auth()->check() && auth()->user()->role === 'admin' && $headingId;
@endphp   

   <h2 class="title editable-title" contenteditable="{{ $isEditable ? 'true' : 'false' }}" data-id="{{ $headingId }}" > {{ $headingTitle }}</h2>

    <p class="lead editable-description" contenteditable="{{ $isEditable ? 'true' : 'false' }}" data-id="{{ $headingId }}" >{{ $headingDescription }}</p>
            ...
            <div class="col-lg-4">
                <div class="feature feature-inline">
                    ...
                    <div class="feature-decoration flex-shrink-0 ms-4">
                        <img src="{{ asset('frontend/images/number/1.png') }}" alt="ContentPilot">
                    </div>
                </div>
            </div><!-- .col -->
            <div class="col-lg-4">
                <div class="feature feature-inline">
                    ...
                    <div class="feature-decoration flex-shrink-0 ms-4">
                        <img src="{{ asset('frontend/images/number/2.png') }}" alt="ContentPilot">
                    </div>
                </div>
            </div><!-- .col -->
            <div class="col-lg-4">
                <div class="feature feature-inline">
                    ...
                    <div class="feature-decoration flex-shrink-0 ms-4">
                        <img src="{{ asset('frontend/images/number/3.png') }}" alt="ContentPilot">
                    </div>
                </div>
            </div><!-- .col -->
        </div><!-- .row -->
        ...
        <div class="row gx-5 gy-6 align-items-center">
            <div class="col-lg-6 col-xl-6">
                <div class="block-gfx pe-xl-5 pe-lg-3">
                    <img class="w-100 rounded-4" src="{{ asset('frontend/images/gfx/feature/a.jpg') }}" alt="ContentPilot">
                </div>
            </div><!-- .col -->
            <div class="col-lg-6 col-xl-6">
