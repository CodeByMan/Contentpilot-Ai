...
@php
    ...
    $headingTitle = $heading?->title ?? 'Create English content faster with AI templates';
    $headingDescription = $heading?->description ?? 'Choose a template, describe your idea, and generate polished English copy for blogs, ads, emails, and landing pages.';
